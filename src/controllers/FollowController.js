...
class FollowController {
    async create(req, res) {
        try {
            ...
            return res.status(201).json({ success: true, data: newFollow });
        } catch (error) {
    ...
    async getFollower(req, res) {
        try {
            ...
            return res.status(201).json({ success: true, data: listFollower });
        } catch (error) {
            return res.status(500).json({ success: false, error: error.message });
        }
    }
    ...
    async getFollowing(req, res) {
        try {
            ...
            return res.status(201).json({ success: true, data: listFollowing });
        } catch (error) {
            return res.status(500).json({ success: false, error: error.message });
        }
    }
